...
//         let mut page_allocated: Vec<usize> = Vec::with_capacity(n_pages);
//         (0..n_pages).into_iter().for_each(|_| page_allocated.push(0));
//         Self {
//             page_allocated,
//             base_addr,
//         }
...
//                     }
//                     let ptr = (self.base_addr + i) as *mut u8;
...
//     let pa = FRAME_ALLOCATOR.get().unwrap().lock().allocate(1) as usize;
//     PhysAddr::new(pa)
// }
