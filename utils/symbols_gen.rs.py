...
for symbol in symbols:
    # print("\tstatic _%s: usize;" % symbol.lower())
    # print("symbol! { __%s, %s, usize }" % (symbol, symbol))
    print("extern \"C\" { static _%s: usize; }" % symbol.lower())
    print("#[inline] pub fn %s() -> usize { unsafe { &_%s as *const _ as _ } }" % (symbol, symbol.lower()))
# print("}")